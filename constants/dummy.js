...
export const trendingCurrencies = [
    ...
    },
    {
        ...
        currency: "ABGC",
        code: "ABGC",
        image: {uri:"https://abgc.abstocks.com/assets/img/brand/favicon.png"},
        amount: "919.03",
        changes: "+0.73%",
        type: "I",
        description: "ABGC is a cryptocurrency invented in 2020 by an unknown person or group of people using the name ABGC. The currency began use in 2021 when its implementation was released as open-source software.",
        chartData: [
            { x: 1, y: 2 },
            { x: 1.5, y: 2.3 },
            { x: 2, y: 2 },
